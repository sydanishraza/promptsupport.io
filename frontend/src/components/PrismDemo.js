        ...
        <div className="space-y-6">
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <h3 className="text-lg font-semibold text-yellow-800 mb-2">
              V2 Engine Simplified HTML (Updated)
            </h3>
            <p className="text-yellow-700 text-sm">
              This content shows the new simplified markup generated by V2CodeNormalizationSystem,
              featuring minimal &lt;pre&gt;&lt;code&gt; pairs with line numbers, language labels, and evidence comments.
              No more figure wrappers or custom toolbars - just clean, Prism-friendly HTML.
            </p>
          </div>
