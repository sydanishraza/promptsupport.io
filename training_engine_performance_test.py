...
BACKEND_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://10a49d77-8e5f-47eb-bb1c-2abe3d39e381.preview.emergentagent.com') + '/api'
...
class TrainingEnginePerformanceTest:
    ...
    def test_enhanced_cors_configuration(self):
        ...
        try:
            ...
            headers = {
                'Origin': 'https://10a49d77-8e5f-47eb-bb1c-2abe3d39e381.preview.emergentagent.com',
