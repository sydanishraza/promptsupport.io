...
BACKEND_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://81ee4b70-33a2-4cdd-a9be-c5f4b7ab4d25.preview.emergentagent.com') + '/api'
...
class TrainingEnginePerformanceTest:
    ...
    def test_enhanced_cors_configuration(self):
        ...
        try:
            ...
            headers = {
                'Origin': 'https://81ee4b70-33a2-4cdd-a9be-c5f4b7ab4d25.preview.emergentagent.com',
