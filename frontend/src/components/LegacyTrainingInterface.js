        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Legacy Training Engine</h1>
                <p className="text-sm text-gray-600 mt-1">
                  ⚠️ Deprecated - Document Upload Processing Lab (Legacy Version)
                </p>
              </div>
            </div>
          </div>
              ...
              <>
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
                  ...
                  <p className="text-xs text-amber-700">
                    This is the original training interface. Use the new Training Engine for latest features.
                  </p>
                </div>
                <TemplateSelector />
                <FileUploadArea />
            ...
            {showResults ? (
              ...
              <div className="text-center py-12">
                ...
                <h2 className="text-xl font-semibold text-gray-900 mb-2">
                  Legacy Lab Testing Interface
                </h2>
                <p className="text-gray-600 mb-6">
                  Select a template and upload a document to test the legacy Knowledge Engine processing.
                </p>
...
export default LegacyTrainingInterface;